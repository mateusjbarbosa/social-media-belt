...
const Links = () => {
  ...
  const { data, mutate } =
    useGet<PaginationWrapper<Link[]>>(tenantId && `/api/${router?.query?.tenantId}/links${cursor}`)
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(submitLink)} className="container w-full mx-auto shadow-md md:w-3/4 mt-8">
              ...
              <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
                  ...
                  <div className="px-5 bg-white py-5 flex flex-col xs:flex-row items-center xs:justify-between">
                    <div className="flex items-center">
                      <NextLink href={`/app/${tenantId}/links?cursor=${data?.cursor}&take=${Math.abs(Number(data?.take)) * -1}`}>
                        <button
                          type="button"
                      ...
                      <NextLink href={`/app/${tenantId}/links?cursor=${data?.cursor}`}>
                        <button
                          type="button"
                          className="w-full p-4 border text-base rounded-l-xl text-gray-600 bg-white hover:bg-gray-100"
